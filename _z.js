 ...
 * [packagist](https://packagist.org/p/hlack/underz) [github](https://github.com/hlaCk/UnderZ)
 *
 * @version 1.1.0
 * @author hlaCk
 */
        ...
        elmFunc = {
            ...
            matches: function elementMatches() {
                ...
                elmFunc.elmLoop( element, function( e ) {
                    ...
                    $return.push(
                        _z.filter(toArray(e), $e => matchesFunction.call($e, arg))
                    );
                    } catch (e) {
...
//             todo: this commented lines
    ...
    var _z = function _z() {
        ...
        let baseSelector = function (info = {}, elements = [], ...data) {
            ...
            _z.extend(true, this, elements, {
                ...
                get: function () { return Array.from(this); },
            });
    ...
    let selectorsHead = function (info = {}, elements = [doc], ...data) {
        ...
        _z.extend(true, this, elements, {
            ...
            length: elements.length,
            get: function () { return Array.from(this); },
            toArray: function () { return Array.from(this); },
        });
    ...
    _z.$ = _z.prototype = {
         ...
         * @return {boolean}
         */
        get exists() { return this.length > 0; },
...
// delete timer
    ...
    ajax.ajaxer = ajax.prototype = {
        ...
        init: function Ajaxer( options, response ) {
            ...
            _z.mix($this,{
                pipe: param.promise,
                then: function(s, e) { return param.promise.then(s).catch(e), this; },
                abort: $this.abort,
                param: param,
...
// todo: remove this
    ...
    join({
        ...
        // type of `val`
        typeOf: function typeOf() { return TOV(arguments[0]).toLowerCase(); },
